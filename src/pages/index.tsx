...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`content seo agency `}</title>

        <meta
          name="description"
          content="Welcome to Content SEO Agency, your ultimate platform for leveraging search engine optimization. Revolutionize your content strategy and drive meaningful engagement."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1667132970685-a2109a3ed00d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb250ZW50fGVufDB8fHx8MTY5ODEyODE1MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@p_kuzovkova?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Polina Kuzovkova`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Content SEO Agency, your ultimate platform for leveraging search engine optimization. Revolutionize your content strategy and drive meaningful engagement.`}
            </Text>
            <Box
