...
import { SeoAnalysisListPage } from 'pages/seo-analyses';
...
function ContentViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; client: boolean } }>(
    () =>
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Keywords" text={data?.keywords} />

                <FormListItem
                  label="Publish Date"
                  text={data?.publish_date ? format(data?.publish_date, 'dd-MM-yyyy') : ''}
                />
